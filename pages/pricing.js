		...
		<Container maxW="container.xl">
			...
			<Section delay={0.4}>
				<p>
					...
					<br />
					<br />
					Mid range pricing valid for matte satin metallic gunmetal grey (either
					dark or lighter shade)
					<br />
					<br />
				...
				<ul style={{ listStyle: 'none' }}>
					...
					<li>
						* Any roof racks and accessories need to be removed before you bring
						your vehicle in. You can leave spoilers.
					</li>
					<li>
						* A picture of your vehicle (the actual vehicle) or parts you need
						to have wrapped, need to be provided regardless if is common or not.
					</li>
					<li>
						* Any extra works like window tinting or mechanical repairs must me
						done before you bring the vehicle in.
					</li>
				</ul>
			</Section>
			...
			<Section delay={0.5}>
				...
				<ul className="ul-pricing">
					<li>Your car will be fully washed and degreased from previous wax</li>
					<li>
						​Windows, air intakes, engine bay, radiator, disk brakes and exhaust
						for protection will be fully masked
					</li>
					<li>
					...
					<li>
						Minimum 8 coats of liquid wrap for strength and durability (in some
						occasions for some colours even more)
					</li>
			...
			<p className="paragraph-note">
				<strong>NOTE:</strong> The actual paint before liquid wrap is applied is
				only washed and treated with safe wax and grease remover and will not be
				sanded or altered in any ways. Any dints or panels imperfections, need
				to be fixed before booking your car if you wish to do so. At times, when
				the car is not in top conditions and only when requested by you, we will
				only flick off any already peeling coating to make the liquid wrap
				adhere properly.
			</p>
		</Container>
	)
