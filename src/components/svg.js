		...
		<>
			...
			<Box>
				<Icon boxSize={14}>
					<svg viewBox="0 0 24 24" focusable="false" className="chakra-icon">
						<g fill={`url(#my-gradient-${useColorModeValue("light", "dark")})`}>
			...
			<Box>
				<Icon boxSize={14}>
					<svg viewBox="0 0 24 24" focusable="false" className="chakra-icon">
						<path
							fill={`url(#my-gradient-${useColorModeValue("light", "dark")})`}
...
// export const MyEditIcon = (fillColor) => {
// 	return (
// 		<svg viewBox="0 0 24 24" focusable="false" className="chakra-icon">
// 			<g
// 				fill={fillColor}
...
// export const MyCalendarIcon = (fillColor) => {
// 	return (
// 		<svg viewBox="0 0 14 14" focusable="false" className="chakra-icon">
// 			<path
// 				fill={fillColor}
...
// export const MyCheckCircleIcon = (fillColor) => {
// 	return (
// 		<svg viewBox="0 0 24 24" focusable="false" className="chakra-icon">
// 			<path
// 				fill={fillColor}
